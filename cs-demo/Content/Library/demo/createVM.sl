...
flow:
  ...
  inputs:
    - host: 10.0.46.10
    - username: "Capa1\\1271-capa1user"
    - password:
        default: Automation123
        sensitive: true
    - datacenter: CAPA1 Datacenter
    - image: Ubuntu
    - folder: Students/Pablo
    - prefix_list: '1-,2-,3-'
  workflow:
    - uuid:
        do:
  ...
  graph:
    steps:
      ...
      wait_for_vm_info:
        ...
        y: 40
        navigate:
          81b79cd7-c952-ec76-eda7-8f8bcbc986c5:
            targetId: 75e14b6a-7b51-c8b3-0f68-37f9aadf9f8e
            port: SUCCESS
    results:
      SUCCESS:
        75e14b6a-7b51-c8b3-0f68-37f9aadf9f8e:
          x: 694
          y: 341
